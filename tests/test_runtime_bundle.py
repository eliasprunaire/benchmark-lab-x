...
class RuntimeBundleTests(unittest.TestCase):
    def test_build_is_commit_bound_reproducible_and_runtime_initializes(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            for name in ('__init__.py', 'model_catalog.py', 'storage.py', 'preparation.py', 'runtime.py', 'service.py', 'openrouter_preparation.py', 'openrouter_prices.py', 'outgoing.py', 'preparation.profile.json', 'qualification.profile.json', 'glm-5.3-flash.profile.json', 'benchmark-runtime'):
