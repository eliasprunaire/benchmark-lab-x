...
class RuntimeBundleTests(unittest.TestCase):
    def test_build_is_commit_bound_reproducible_and_runtime_initializes(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            git('init')
            git('add', 'benchmark', 'tools/build_runtime.py')
            ...
            subprocess.run([sys.executable, '-c', 'from benchmark.service import serve_executor, serve_web'], cwd=unpacked, check=True)
