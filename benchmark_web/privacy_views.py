...
def render_privacy_page(value, csrf=''):
    if value['kind'] == 'privacy_notice':
        ...
        return 'Confidentialité', (
            ...
            '<li>Après suppression, des copies résiduelles peuvent subsister dans les sauvegardes pendant 7 jours.</li>'
...
def render_privacy_controls(value, csrf):
    ...
    if dossier:
        ...
        content += privacy_form('delete', csrf, '/preparation/dossiers/' + quote(dossier, safe='') + '/delete', {},
            ...
            'sur le serveur, ainsi que celle de sa contribution éventuelle. Les sauvegardes peuvent '
            'en garder une copie résiduelle 7 jours.</p>'
