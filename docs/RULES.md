...
**Jalon initial.** `0.1.0` désigne le périmètre approuvé dans le [PRD](PRD.md#51-capacités), avec ses critères d’acceptation. Ce numéro ne requalifie aucun résultat déjà scellé et ne prouve aucune livraison. Aucun autre jalon chiffré n’est déduit de cette décision.
