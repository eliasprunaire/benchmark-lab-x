...
Le panel nominal retenu par Ayo pour 0.1.0 est : GLM5.3, DeepSeek V4.1 Flash, Muse spark 1.3, Hy4 Preview, Minimax M3, Qwen3.8-Max-0902, Mimo-V2.5-Pro, Gemini 3.8 Flash, Kimi k3 et Grok 4.6. La révision `0902` de Qwen est exigée. DeepSeek V4.1 Flash remplace la version 0731, retirée des nouveaux essais et des assistants à sélectionner. Les résultats historiques conservent leur identité d’origine.
